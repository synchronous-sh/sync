...
final class ShareViewController: UIViewController, UITextViewDelegate {
    private let paper = UIColor.black
    private let raised = UIColor(red: 0.039, green: 0.039, blue: 0.039, alpha: 1)
    private let ink = UIColor.white
    private let muted = UIColor.white.withAlphaComponent(0.60)
    private let line = UIColor.white.withAlphaComponent(0.10)
    private let selectedLabel = UIColor.black
